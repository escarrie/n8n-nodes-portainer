	...
	description: INodeTypeDescription & { usableAsTool?: boolean } = {
		...
		properties: [
			...
			// ===========================================
			{
				...
				},
				{
					...
					value: 'getStatus',
						...
						description: 'Get deployment status of the edge stack',
					routing: {
						request: {
							method: 'GET',
			...
			// ===========================================
			{
				...
				options: [
					...
					},
					{
						...
						value: 'getHistory',
						action: 'Get history',
						description: 'Get an image\'s history',
						routing: {
							request: {
								method: 'GET',
			...
			},
			{
				...
				default: 0,
				description: 'Object version to update',
			},
			...
			},
			{
				...
				default: '',
				description: 'Content of the docker-compose.yml or stack file',
			...
			// ===========================================
			{
				...
				default: '',
				description: 'The content of the docker-compose.yml or stack file',
				placeholder: 'version: "3.8"\nservices:\n  web:\n    image: nginx:latest',
			},
			{
				displayName: 'Environment Variables',
