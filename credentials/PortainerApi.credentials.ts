...
export class PortainerApi implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			default: '',
			required: true,
			description: 'Your Portainer API Key. Find it under Settings > Access Tokens in your Portainer account.',
		...
		rules: [
			{
				...
				properties: {
					key: 'Id',
					value: undefined,
					message: 'Invalid API key or server unreachable. Verify the URL and API key.',
				},
			},
		],
	};
